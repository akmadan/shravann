    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden w-1/2 flex-col items-center justify-center bg-[#111111] p-16 lg:flex">
        <div className="max-w-md space-y-8">
          <div className="text-5xl text-[#22c55e]">&ldquo;</div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#22c55e]/20 text-lg font-bold text-[#22c55e]">
              S
            </div>
            <div>
